...
export default function Introduce() {
  return (
    <div className="col-center py-8">
      ...
      <div className="flex w-full flex-col justify-start gap-4 py-8">
        <div>
          <p>안녕하세요! 수어 번역 서비스에 오신 것을 환영합니다!</p>
          <p>
            우리는 ChatGPT API, Bard API를 활용하여 수어 번역 서비스를
            제공합니다.
          </p>
          <p>
            수어 번역 서비스는 장애인, 외국인, 혹은 수어를 모르는 사람들에게
            유용하며,
          </p>
          <p>
          ...
          <p>세상을 더 나은 곳으로 만드는 데 도움이 되기를 바랍니다.</p>
        </div>
